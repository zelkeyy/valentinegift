const CONFIG = {
    ...
    subQuestion: "Pliss harus mau yaa ",
    yesButton: "MAU",
    noButton: "GAMAU",
    ...
    flowerTitle: "Ini kado spesial buat kaka kesayangan aku ",
    takeBouquetButton: "Terima hadiahnya ",
    bouquetMessage: "Yeayy! Udah jadi punya kaka 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Favorite Person",
    collageSubtitle: "Sejak deket sama kaka, aku jadi lebih semangat buat ngejalanin hari hari aku. Happy Valentine yaaaa, kaka kesayangankuu. 💕",
    nextCollageButton: "Satu halaman lagi yaa… ",
    finalTitle: "Happy Valentine, Kakak Sayangg 💞",
    finalMessage: `Makasi bangett yaa udah mau nerima aku dengan baikk. Aku harap hubungan kita engga bakal renggang lagi and makin deket tiap harinyaa. Aku harap hari kaka bakal full sama hal hal yang bikin kaka bahagiaa. Kalo ada apa apa cerita ke aku aja yaa, i will always be here for u, I will always support u whatever u do (kalo positif ya). Soo, Happy Valentine kaka kesayangan akuu. Wopiuuuu 💕`,
